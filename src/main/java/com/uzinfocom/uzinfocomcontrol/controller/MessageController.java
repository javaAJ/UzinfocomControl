...
public class MessageController {
    ...
    @Scheduled(cron = "0 45 11 * * *",zone = "Asia/Tashkent") // Каждый день в 9:00
    ...
    @Scheduled(cron = "0 47 11 * * *",zone = "Asia/Tashkent") // Каждый день в 9:00
    ...
    @Scheduled(cron = "0 46 11 * * *",zone = "Asia/Tashkent") // Каждый день в 9:00
